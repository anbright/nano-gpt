...
Andrej's sample code to use mps backends.
"""
def get_backend():
        # 1. Start with the assumption of using CPU
    device = 'cpu'
    ...
    # 3. Check for MPS (Apple Silicon/M1/M2/M3)
    elif hasattr(torch.backends, 'mps') and torch.backends.mps.is_available():
        device = 'mps'
        print("Using MPS (Apple Silicon GPU) for training.")
        
    # 4. Fallback to CPU if neither is available
    else:
